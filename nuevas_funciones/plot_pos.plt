...
reset
set term gif enhanced background rgb 'black' size 800,800 font "Helvetica,25" animate delay 2 
...
plot "posiciones.txt" index i using 1:2:(column(0)>0 ? 0.5 : 1.5):(column(0)>0 ? 12 : 11) pt 7 ps variable lc variable notitle, -1 with points pt '' title "t = ".((i+1)*200)." Myr"
}
