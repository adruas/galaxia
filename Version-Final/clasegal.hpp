...
private:
    ...
    cAgujero Negro;
    double inercia, angular, vecExcent[numsist];
...
public :
   ...
   //Método de los choques inelésticos que devuelve el numero de choques que ha habido
   int choqueInelastico(cSistema (&Solar)[numsist]);
   ...
   void excentricidad(cSistema(&Solar)[numsist],double (&vecExcent)[numsist]);
};